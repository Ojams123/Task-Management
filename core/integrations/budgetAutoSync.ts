...
import type { BudgetCategory, SimplefinTransaction } from '../../src/shared/types'

// Extra keywords per common category name, so a bank merchant/category string
...
/**
 * Turns newly-synced SimpleFIN transactions into real budget ledger entries,
 * so category spent-vs-limit totals reflect actual bank activity without
 * manual entry. Safe to call after every sync — already-linked transactions
 * are skipped via their stored simplefinTransactionId. SimpleFIN's sign
